...
public:
  ...
  BitmapRenderer(QWidget *parent = 0, int pixel_size = 20,
                 bool no_scroll = false, QUndoStack *undoStack_ = nullptr);
...
public slots:
  void clearAndLoadBitmap(const IBMFDefs::Bitmap     &bitmap,
...
private:
  ...
  QUndoStack
      *undoStack_;     // The master undo stack as received from the main window
  ...
  IBMFDefs::Preamble
      preamble_; // Copies of the font structure related to the current glyph
